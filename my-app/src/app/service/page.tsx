    ...
    return (
        <div className="bg-white text-black min-h-screen flex flex-col items-center justify-center p-6">
            ...
            <div className="flex flex-wrap justify-center mb-4">
                ...
                <div className="max-w-sm rounded-[1rem] overflow-hidden shadow-lg bg-white border border-gray-300 m-4">
                    ...
                    <div className="px-6 pt-4 pb-2">
                        <button className="bg-rose-500 text-white px-4 py-2 rounded-[1rem] hover:bg-rose-700 transition">
                            Add to Order
                        </button>
                    </div>
                </div>
