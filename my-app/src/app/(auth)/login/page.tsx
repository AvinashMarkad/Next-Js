...
// import { useRouter } from "next/router"; some time it comes default change router with navigation
            ...
            <div className="max-w-md w-full bg-gray-100 rounded-lg p-8 shadow-md">
                ...
                <form>
                    ...
                    <div className="flex justify-between mb-4">
                        ...
                        <Link href="/admin" className="text-blue-500 hover:text-blue-700 text-sm">Admin Login</Link>
