            ...
            <div className="max-w-md w-full bg-gray-100 rounded-[1rem] p-8 shadow-md">
                ...
                <form>
                    ...
                    <div className="flex justify-between mb-4">
                        <Link href="/forgot-password" className="text-rose-500 hover:text-rose-700 text-sm">
                            Forgot Password?
                        </Link>
                        <Link href="/login" className="text-rose-500 hover:text-rose-700 text-sm">
                            Login
                        </Link>
                        <Link href="/register" className="text-rose-500 hover:text-rose-700 text-sm">
                            Register
                        </Link>
                    </div>
